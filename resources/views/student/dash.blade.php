    ...
    <div class="row display-table-row">
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
            <div class="text-center">
                <a href="{{route('student_dashboard')}}"><img src="{{asset('img/dash_logo.png')}}" width=50 height=60 alt="merkery_logo" >
                </a>
            </div>
            <div class="navi">
                <ul>
                    <li class="active"><a href="{{route('student_dashboard')}}"><i class="fas fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Profile</span></a></li>
                    <li><a href="{{route('student_show_logbook',['week_no'=>1])}}"><i class="fas fa-book-open" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Log Book</span></a></li>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                <li><a href="{{route('student_dashboard')}}">Profile</a></li>
                                <li><a href="{{route('student_show_logbook',['week_no'=>1])}}">Log Book</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="{{route('student_update_bank')}}">Update Bank Details</a></li>
                                <li><a href="{{route('student_update_password')}}">Update Password</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="header-rightside">
                            <ul class="list-inline header-top pull-right">
                                <!--                                <li class="hidden-xs"><a href="{{route('coordinator_show_create_student')}}" class=" btn-primary btn-sm" >Add Student</a></li>-->
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <div class="navbar-content">
                                                    <span>{{getUser()->getInfo()->getFullName()}}</span>
                                                    <p class="text-muted small">
                                                        {{getUser()->getInfo()->getEmail()}}
                                                    </p>
                                                    <div class="divider">
                                                    </div>
