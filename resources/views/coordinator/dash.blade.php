    ...
    <div class="row display-table-row">
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
            <div class="text-center">
                <a href="{{route('coordinator_dashboard')}}"><img src="{{asset('img/dash_logo.png')}}" width=50 height=60 alt="merkery_logo" >
                </a>
            </div>
            <div class="navi">
                <ul>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                <li><a href="{{route('coordinator_dashboard')}}">Profile</a></li>
